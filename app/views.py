...
def upload_file():
    ...
    if request.method=='POST' and form.validate_on_submit():
        ...
        if file and allowed_file(file.filename):
            ...
            form=ResultForm()
            return render_template("result.html",title="Result",form=form,path=os.path.join('static/img/upload/',new_filename),result=result[0],pred=pred)
        else:
            msg="Wrongfileformat:"+file.filename
            flash(msg,"warning")
